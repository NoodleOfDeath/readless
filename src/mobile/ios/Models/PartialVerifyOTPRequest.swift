...
public struct PartialVerifyOTPRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(email: String? = nil, eth2Address: String? = nil, otp: String? = nil, phone: String? = nil, thirdParty: ThirdPartyAuth? = nil, userId: Double? = nil, username: String? = nil, thirdPartyGoogle: String? = nil) {
        self.email = email
