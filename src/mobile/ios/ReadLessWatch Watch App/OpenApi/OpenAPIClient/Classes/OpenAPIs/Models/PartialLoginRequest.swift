...
public struct PartialLoginRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(email: String? = nil, eth2Address: String? = nil, otp: String? = nil, phone: String? = nil, thirdParty: ThirdPartyAuth? = nil, userId: Double? = nil, username: String? = nil, thirdPartyGoogle: String? = nil, eth2SignedMessage: String? = nil, password: String? = nil, requestedRole: String? = nil, requestedScope: [String]? = nil) {
        self.email = email
