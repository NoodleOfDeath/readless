...
const fallbackImageSelectors = [
  ...
  'article :not(header) figure picture source[type*="image"]:not([srcset*=".svg"]):not([srcset*=".gif"]):not([srcset*="data:image"])',
  ...
  'article :not(header) figure source[type*="image"]:not([srcset*=".svg"]):not([srcset*=".gif"]):not([srcset*="data:image"])',
  'article :not(header) picture source[type*="image"]:not([srcset*=".svg"]):not([srcset*=".gif"]):not([srcset*="data:image"])',
