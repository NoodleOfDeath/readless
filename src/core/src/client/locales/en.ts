export const enStrings = {
  ...
  dailyReminderDescription: 'This is your daily reminder to read the news and stay informed!',
  ...
  more: 'More',
  most: 'Most',
  mostReadsInThsPastWeek: 'Most Reads in the Past Week',
  mostSharesInThsPastWeek: 'Most Shares in the Past Week',
  negative: 'Negative',
  neutral: 'Neutral',
