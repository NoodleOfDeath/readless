  ...
  return (
    <ReactCookieConsent
      ...
      <TruncatedText showLessText="(show less)">
        ...
        use of our website, such as your browsing behavior, preferences, and
        other non-personal information. We use this data to improve the user
        experience and for analytical purposes. If you do not wish to have
        cookies stored that collect user data, you can go to the cookie settings
        page and opt-out. Please note that disabling certain cookies may impact
        your user experience on our website. By continuing to use our website,
        you agree to our use of cookies as outlined in this disclaimer.
      </TruncatedText>
    </ReactCookieConsent>
  );
}
